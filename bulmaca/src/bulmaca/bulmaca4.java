...
{
	static String[] bulmaca = {"la","antik","nara","es","fa","labne","an","as","týr","af","eke"};
	static String[] sorular = {"Bir nota (1-2)","Eski çaðlara ait (6-10)","Haykýrma, baðýrma (16-19)","Bilinç, þuur, Notada durak isareti (21-22)","Bir nota (24-25)","Sürülebilir peynir (1-21)","En kýsa zaman, tarla sýnýrý (2-7)","Iskambilde birli, deðirmen (17-22)","Uzun ve geniþ yük taþýma aracý (8-18)","Baðýþlama (19-24)","Tecrübeli, kurnaz (5-15)"};
