...
{
	static String[] bulmaca = {"tablo","kütük","in","tik","tokat","betik","ün","ork"};
	static String[] sorular = {"Yaðlýboya resim (1-5)","Resmi kayýt defteri (11-15)","Maðara (18-19)","Ýstem dýþý kas hareketi (21-23)","Cezalý hayvanlarýn kapatýldýðý yer, bir ilimiz (1-21)","Basýlý veya yazýlý kaðýt yapraklarýn bütünü (3-23)","Þan, þöhret (14-19)","Hayvanlarý baðlamaya yarayan kalýn ip ya da zincir (5-15)"};
