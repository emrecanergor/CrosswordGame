...
public class bulmaca9 extends ortak 
{
	static String[] bulmaca = {"dümen","laz","es","nesne","ar","er","ena","ülser","ma","ezine","er"};
	static String[] sorular = {"Hava ve deniz taþýtlarýnýn, taþýta yön vermeye yarayan devingen parçasý. (1-5)","Güney Kafkasyalý bir halk ve bu halkýn soyundan olan kimse. (7-9)","Bilinç, þuur (11-12)","Obje (16-20)","Namus (21-22)","Asker, erken (24-25)","Kara yumuþakçasý (11-21)","Mukoza altý dokularý meydanda býrakan kronik yaralar (2-22)","Eski dilde su (3-8)","Bir peynir çeþidi (4-24)","Asker, erken (20-25)"};
