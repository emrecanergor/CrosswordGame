...
public class bulmaca10 extends ortak 
{
	static String[] bulmaca = {"kanýt","oya","lav","ukala","konuk","ay","nalan","az","tava"};
	static String[] sorular = {"Bir þeyin doðruluðu, gerçekliði konusunda inandýrýcý belge (1-5)","Ýðne, týð ya da firketeyle yapýlan, ince dantel (6-8)","Püskürtü (13-15)","Bilgiçlik taslayan (16-20)","Misafir (1-21)","Yeryuvarlaðýnýn uydusu olan gökcismi (2-7)","Acýdan inleyen (3-23)","Seyrek, eksik (14-19)","Yemek yapmak için kullanýlan uzun saplý yayvan kap (5-20)"};
