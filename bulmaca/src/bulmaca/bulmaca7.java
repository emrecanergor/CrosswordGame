...
{
	static String[] bulmaca = {"sal","aracý","hale","er","ar","na","sahra","ara","lale","cern"};
	static String[] sorular = {"Ýlkel su taþýtý (1-3)","Uzlaþtýran, anlaþma saðlayan kimse (6-10)","Ayla (11-14)","Asker, erken (18-19)","Namus (21-22)","Sodyum'un simgesi, olumsuzluk öneki (24-25)","Dünyanýn en büyük çölü (1-21)","Ýki þeyi birbirinden ayýran uzaklýk, boþluk (2-12)","Bir süs bitkisi (3-18)","Dünyanýn en büyük parçacýk fiziði laboratuvarý (9-24)"};
