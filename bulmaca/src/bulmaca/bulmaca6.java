...
{
	static String[] bulmaca = {"topuk","kaný","keçe","para","ok","ep","parça","un","er","kýn"};
	static String[] sorular = {"Ayaðýn toparlakça olan alt arka bölümü (1-5)","Kanaat, inanýlan düþünce (7-10)","Dövülerek yapýlan kaba kumaþ (16-19)","Nakit (22-25)","Yay ile hedefe atýlan, ince ve kýsa tahta çubuk (2-7)","Týp dilinde dýþ gebelik (17-22)","Lime (3-23)","Tahýllarýn incecik öðütülerek toz durumuna getirilmiþi. (4-9)","Asker, erken (19-24)","Kýlýç, hançer, kama gibi kesici araçlarýn kabý (5-15)"};
